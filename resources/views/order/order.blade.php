    ...
    <div class="row my-3" > 
                    ...
                    <table class="table table-borderless table-shopping-cart">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <figure class="itemside align-items-center">
                                        <div class="aside">
                                            ...
                                            <img src="{{asset("uploads/books/$list_books->image")}}" class="img-sm">
                                        </div>
                                ...
                                <td>  
                                    <input type="number" name="qty" id="" min="1" value="{{session('qty')}}" style="width: 70px;
                                    text-align: center;">
                                <td>
                                    <div class="price-wrap"> <var class="price">{{number_format($list_books->price*session('qty'))." ". "VNĐ"}}</var> </div>
                                </td>    
                            </tr>
        ...
        <aside class="col-lg-3">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body"> 
                    <p style="text-align: left;">Thông tin vận chuyển: {{$delivery['village']}}, {{$delivery['wards_name']}}, {{$delivery['province_name']}}, {{$delivery['city_name']}}.</p>
                </div>
            ...
            <div class="card">
                <form action="{{route('checkout.insert_order')}}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <dl class="dlist-align">
                            <dt>Tổng:</dt>
                            <dd class="text-right text-dark b ml-3"><strong>{{number_format($totalPrice, 2) . " VNĐ"}}</strong></dd>
