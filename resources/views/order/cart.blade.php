...
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=BIZ+UDPGothic&family=Playfair+Display:ital,wght@0,400;1,400;1,500&family=Source+Sans+Pro:wght@200&display=swap" rel="stylesheet">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
...
<div class="navigation" id="nav">
    ...
    <div class=" menu-bar" style="display: flex ">
       ...
       <a id="cart" href="{{route('cart.')}}" style="color: red;"><i class="fa fa-shopping-bag" aria-hidden="true"></i></a>  
    </div>
...
<div class="container-fluid">
  ...
  <div class="toast" id="toast-msg" role="alert" class="" aria-live="assertive" aria-atomic="true" style="display: inline-block; background-color:     background-color: rgb(236, 146, 146,5); ">
    <div class="toast-header" style="position: relative;">
    <img src="{{asset("assets/images/error/discount_error.png")}}" style="max-width: 50px; height: 50px" class="rounded mr-2" alt="...">
    <strong class="mr-auto" style="font-size: 17px; margin-left: 10px;" >Sach ok</strong>
   
    <button type="button" class="ml-2 mb-1 close" onclick="hide()" data-dismiss="toast" aria-label="Close" style="background: none; border: none; font-size: 25px; padding: 5px 10px; position: absolute; top: 0px; right: 0px;">
                        ...
                        <tbody>
                           ...
                           <form action="{{route('cart.update')}}" method="POST">  
                            ...
                            <tr>
                                ...
                                <td>  
                                    <input type="number" name="qty" id="" min="1" value="{{$book->qty}}" style="width: 70px;
                                    text-align: center;">
                                    <input type="hidden" name="rowId" value="{{$rowId}}">
                                    <input type="hidden" name="book_id" value="{{$book->id}}">
                                    
                                <td>
                                    <div class="price-wrap"> <var class="price">{{number_format($book->price*$book->qty)." ". "VNĐ"}}</var> </div>
                                </td>
                                <td class="text-right d-none d-md-block" style="margin-left: 50px;"> 
                                    <button data-original-title="Save to Wishlist" title="" href="" class="btn btn-light" data-toggle="tooltip" data-abc="true"> 
                                        <i> Update</i>
                                    </button>
                                    <a href="{{route('cart.remove', ['id' => $rowId, 'book_id' => $book->id])}}" class="btn btn-light btn-round" data-abc="true">Remove</a></td>     
                            </tr>
                        </form>  
                            @endforeach
                        </tbody>
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('cart.discount')}}">
                        ...
                        <div class="form-group"> <label>Nhập mã giảm giá?</label>
                            <div class="input-group"> <input type="text" class="form-control coupon" name="code" placeholder="Mã giảm giá">
            ...
            <div class="card">
                <form action="{{route('checkout.')}}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <dl class="dlist-align">
                            <dt>Tổng:</dt>
                            <dd class="text-right text-dark b ml-3"><strong>{{$totalPrice . " VNĐ"}}</strong></dd>
