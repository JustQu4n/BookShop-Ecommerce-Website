                    ...
                    <tbody>
                        @foreach ($list_discounts as $item)
                            <tr>
                                ...
                                <td>
                                    @if ($item->status == 1)
                                        <a href="{{ route('discount.unactive', ['id' => $item->id]) }}">
                                            <sapn class="">Có</sapn>
                                        </a>
                                    @else
                                        <a href="{{ route('discount.active', ['id' => $item->id]) }}">
                                            <sapn>Không</sapn>
                                        </a>
                                    @endif
                                ...
                                <td>
                                    <a href="{{ route('discount.update', ['id' => $item->id]) }}" class="active"
                                        ui-toggle-class="">
                                        <i class="fa fa-pencil-square-o text-success text-active"></i>
                                    </a>
                                    <a href="{{ route('discount.delete', ['id' => $item->id]) }}" class="active"
                                        ui-toggle-class="">
