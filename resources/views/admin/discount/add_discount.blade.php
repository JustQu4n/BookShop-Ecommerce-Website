                ...
                <div class="panel-body">
                    <div class="position-center">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="code" id="exampleInputEmail1" value="{{old('code')}}">
                            @error('code')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="percent_discount" id="exampleInputEmail1" value="{{old('percent_discount')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="date_end" id="exampleInputEmail1" value="{{old('date_end')}}">
                            @error('date_end')
                                <p style="color:red; ">{{$message}}</p>
                            @enderror
                        </div>
