            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="position-center">
                        <form role="form" action="{{route('book.updatePost', ['id' => $id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Tên sách: </label>
                            <input type="text" class="form-control" name="author" id="exampleInputEmail1" value="{{$book->author}}">
                            @error('author')
                                <p style="color:red; ">{{$message}}</p>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="price" id="exampleInputEmail1" value="{{$book->price}}">
                            @error('price')
                                <p style="color:red; ">{{$message}}</p>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="publisher" id="exampleInputEmail1" value="{{$book->publisher}}">
                            @error('publisher')
                                <p style="color:red; ">{{$message}}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="year" id="exampleInputEmail1" value="{{$book->year}}">
                            @error('year')
                                <p style="color:red; ">{{$message}}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="total_page" id="exampleInputEmail1" value="{{$book->total_page}}">
                            @error('total_page')
                                <p style="color:red; ">{{$message}}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <img src="{{asset("uploads/books/$book->image")}}" alt=""style="width: 150px; height: 150px;" >
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control input-sm m-bot15" name='book_category'>
                                @foreach ($list_categories as $category)
                                    <option value="{{$category->id}}" {{$category->id ==$book->category_id?'selected="true"':false}}>{{$category->name}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control input-sm m-bot15" name='book_brand'>
                                @foreach ($list_brands as $brand)
                                    <option value="{{$brand->id}}" {{$brand->id == $book->brand_id?'selected="true"':false}}>{{$brand->name}}</option>
                                @endforeach
                            </select>
                            @error('book_brand')
                                <p style="color:red; ">{{$message}}</p>
