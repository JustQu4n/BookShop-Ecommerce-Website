            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="position-center">
                        <form role="form" action="{{ route('product.updatePost', ['id' => $id]) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="price" id="exampleInputEmail1"
                                    value="{{ old('price') }}"placeholder="Tên danh mục ....">
                                @error('price')
                                    <p style="color:red; ">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea style="resize: none; row=8" class="form-control" name="product_desc" id="exampleInputPassword1"
                            ...
                            <div class="form-group">
                                ...
                                <textarea style="resize: none; row=8" class="form-control" name="product_content" id="exampleInputPassword1"
                                    placeholder="Mô tả danh mục...">
                                {{ old('product_content') }}
                            </textarea>
