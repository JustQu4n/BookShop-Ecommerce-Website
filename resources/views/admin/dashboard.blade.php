...
<script>
	...
	var colorDanger = "#FF1744";
			...
			data: [
				{label:"Tổng số sách", value:{{$data['book_qty']}}, color:colorDanger},
				{label:"Tổng số khách hàng", value:{{$data['user_qty']}}, color:'#F0B57B'},
				{label:"Sự kiện display", value:{{$data['event_qty']}}, color:'#CC9C85'},
				{label:"Đơn hàng", value:{{$data['order_qty']}}},
