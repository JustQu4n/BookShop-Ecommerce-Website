        ...
        <div class='container'>
                                    ...
                                    <div class="accordion">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="{{ route('shop.category', ['id' => $category->id]) }}"
                                                    style="color: black; text-decoration: none">{{ $category->name }}</a>
                                            </li>
                                            @endforeach
                                            </li>
                                        </ul>
                                    ...
                                    <div class="sidebar-widget-body m-t-10">
                                        <div class="price-range-holder">
                                            <div class="list-price">
                                                <input type="number" min="0" name="min_price" value="0">
                                                <input type="number" min="50000" name="max_price" value="50000">
                                            </div>
                                        </div>
                                ...
                                <div class="sidebar-widget-body">
                                    <ul class="list">
                                        ...
                                        @foreach ($list_brands as $brand)
                                            <li><a
                                                    href="{{ route('shop.brand', ['id' => $brand->id]) }}">{{ $brand->name }}</a>
                                            </li>
                                        @endforeach
            ...
            <div class="item">
              <div class="image"> <img src="{{asset('assets\images\slider\DongA11_840x320.jpg')}}" alt="" > </div>
                                                    ...
                                                    <div class="products">
                                                        <div class="product">
                                                            ...
                                                            <div class="product-info text-left">
                                                                <h3 class="name"><a
                                                                        href="{{ route('detail', ['id' => $book->id]) }}">{{ $book->name }}</a>
                                                                </h3>
                                                                <div class="rating rateit-small"></div>
                                                                <div class="description"></div>
                                                                <div class="product-price"> <span class="price">
                                                                        {{ number_format($book->price) }} đ</span> <span
                    ...
                    <div id="category" class="category-carousel hidden-xs">
                        <div class="item">
                            <div class="image"> <img src="{{ asset('assets\images\slider\DongA11_840x320.jpg') }}"
                                    alt=""> </div>
