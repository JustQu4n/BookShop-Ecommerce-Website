...
<div class="content-menu" style="width : 100%;">
    <div class="content-menu">
        <div class="title-menu">
            <h2>Book</h2>
            <p><a href="">Home</a>-><a href="">Shop</a>-><a href="">Drama</a>-><a href="">A Banquet of
                    Moue</a></p>
        </div>
    </div>
</div>  
...
@section('content')
@if (session('add_cart'))
<div class="toast" role="alert" aria-live="assertive" aria-atomic="true" style="z-index:1000000; position:absolute; right: 15px; top: 50px; display: block;">
    <div class="toast-header">
    <img src="{{asset("uploads/books/$book->image")}}" style="max-width: 50px; height: 50px" class="rounded mr-2" alt="...">
    ...
    <div class="content-container">
        ...
        <div class="content-book">
            ...
            <div class="info-book">
                <div class="title-book">
                    ...
                    <div class="qty-buy">
                        <form id="myForm" action="{{route('checkout.')}}" style="min-width: 500px;" method="POST">
                            @csrf
                            ...
                            <div class="qty" style="display: inline-block;">
                                <input type="number" min="1" value="1" inputmode="numeric" autocomplete="off" name="cart_qty" class="cart_book_qty_{{$book->id}}">
                            </div>
                            ...
                            <div class="cart" style="margin-left: 20px; display: inline-block; ">
                                <button name="btn" value="cart" class="add-cart" data-id="{{$book->id}}">Thêm vào giỏ hàng</button>
                            </div>
                    ...
                    <div class="my-3">
                        <div class="fb-share-button" data-href="http://127.0.0.1:8000/product/{{$id}}" data-layout="button_count" data-size="large">
                            <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http://http://127.0.0.1:8000/product/{{$id}};src=sdkpreparse" class="fb-xfbml-parse-ignore">Chia sẻ</a>
                        </div>
                        <div class="fb-like" data-href="http://127.0.0.1:8000/product/{{$id}}" data-width="" data-layout="button_count" data-action="like" data-size="large" data-share="false"></div>
        ...
        <div clas="book-description">
            <div class="button-changepage">
                <div class="bt-chg">
                    <button class="tablink act" id="des" onclick="openPage('mota', this, 'revi','review')">Tóm tắt nội dung</button>
                    <button class="tablink" id="revi" onclick="openPage('review', this, 'des','mota')">Đánh giá</button>
                </div>
            </div>
            <div class="page-description">
                ...
                <div id="review" class="tabcontent" >
                    <div class="fb-comments" data-href="http://127.0.0.1:8000/product/{{$id}}" data-width="" data-numposts="5"></div>
                </div>
