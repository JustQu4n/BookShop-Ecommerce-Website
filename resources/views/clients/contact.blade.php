...
@section('content')
    ...
    <div class="contact row">
        ...
        <div class="col-md-4 contactwithus">
            <h1>Liên hệ</h1>
            <span class="infor">
                <span class="address"><span style="color: rgb(0, 0, 0); font-size: 24px;">Địa chỉ : </span> 470 Trần Đại
                    Nghĩa, Hòa Hải, Ngũ Hành Sơn, Đà Nẵng</span>
                <span class="telephone"><span style="color: rgb(0, 0, 0); font-size: 24px;">Số điện thoại : </span> +84
                    705256624</span> <br>
            ...
            <form action="" method="POST">
                ...
                <div class="row textarea">
                    <textarea name="message" cols="30" rows="10"
                        ...
                        aria-invalid="false" placeholder="Nội dung">
                    {{ old('message') }}
                </textarea>
                    @error('message')
                        <p style="color:red; text-align: left; text-transform:none;">{{ $message }}</p>
