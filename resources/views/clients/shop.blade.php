...
<div class="content content-shop">
    <div class="content-container container-shop">
               ...
               <div class="list-category">
                    <ul type="none">
                        @foreach ($list_brands as $brand )
                            <li><a href="{{route('shop.brand', ['id' => $brand->id])}}" style="color: black; text-decoration: none">{{$brand->name}}</a></li>
                        @endforeach 
                     </ul>       
                </div>
            </div>
        ...
        <div class="listbook-container">
                <div id="name_category"><h5 style="font-family: 'Varela Round', sans-serif;padding-top:5px">{{$name}}</h5></div> 
                <div class="browse-tags pull-right hidden-xs">
                        <form>
                            @csrf
                            <span class="custom-dropdown custom-dropdown--white">
                                <select class="sort-by custom-dropdown__select custom-dropdown__select--white" id="filter" name="sort-by">
