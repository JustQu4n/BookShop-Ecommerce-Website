...
Route::prefix('ad')->group(function () {
    ...
    Route::get('/list_view', [AdminController::class, 'list_view']) -> name('list_view');
    Route::get('list_order', [AdminController::class, 'list_order']) -> name('list_order');

    // user
    Route::prefix('user')->group(function () {
        Route::get('list_user', [UserController::class, 'list_user']) -> name('list_user');
        Route::get('block/{id}', [UserController::class, 'block_account']) -> name('block_account');
        Route::get('active_account/{id}', [UserController::class, 'active_account']) -> name('active_account_1');
